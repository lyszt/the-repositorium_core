import { addTrailingSlash, node_path, addLeadingSlash } from "../4942.js";
import { createError } from "./utils/error.js";
import { haveNavSidebarConfig as auto_nav_sidebar_haveNavSidebarConfig } from "./auto-nav-sidebar/index.js";
class PluginDriver {
    #config;
    #configFilePath;
    #plugins;
    ...
    async init() {
        ...
        if (enableLastUpdated) {
            const { pluginLastUpdated } = await import("./last-updated/index.js");
            this.addPlugin(pluginLastUpdated());
        }
        if (mediumZoomConfig) {
            const { pluginMediumZoom } = await import("./medium-zoom/index.js");
