import { SEARCH_INDEX_NAME, groupBy } from "../../../4942.js";
...
async function createPageData(context) {
    ...
    const versioned = 'boolean' != typeof userConfig.search && (userConfig.search?.versioned ?? true);
