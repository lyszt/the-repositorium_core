...
__webpack_require__.add({
    ...
    "../../node_modules/.pnpm/cross-spawn@7.0.6/node_modules/cross-spawn/lib/parse.js" (module, __unused_rspack_exports, __webpack_require__) {
        const path = __webpack_require__("path?aeb1");
    ...
    "../../node_modules/.pnpm/cross-spawn@7.0.6/node_modules/cross-spawn/lib/util/readShebang.js" (module, __unused_rspack_exports, __webpack_require__) {
        const fs = __webpack_require__("fs?8b28");
    ...
    "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/mode.js" (module, __unused_rspack_exports, __webpack_require__) {
        module.exports = isexe;
        isexe.sync = sync;
        var fs = __webpack_require__("fs?8b28");
        function isexe(path, options, cb) {
    ...
    "../../node_modules/.pnpm/merge-stream@2.0.0/node_modules/merge-stream/index.js" (module, __unused_rspack_exports, __webpack_require__) {
...
const npmRunPath = ({ cwd = node_process.cwd(), path: pathOption = node_process.env[pathKey()], preferLocal = true, execPath = node_process.execPath, addExecPath = true } = {})=>{
    ...
    const cwdPath = node_path.resolve(cwdString);
    const result = [];
...
const applyExecPath = (result, execPath, cwdPath)=>{
    ...
    result.push(node_path.resolve(cwdPath, execPathString, '..'));
};
...
const contents_getStreamContents = async (stream, { init, convertChunk, getSize, truncateChunk, addChunk, getFinalChunk, finalize }, { maxBuffer = 1 / 0 } = {})=>{
...
const merge_stream = __webpack_require__("../../node_modules/.pnpm/merge-stream@2.0.0/node_modules/merge-stream/index.js");
