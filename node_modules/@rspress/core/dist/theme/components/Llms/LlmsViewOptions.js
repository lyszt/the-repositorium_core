/*! LICENSE: LlmsViewOptions.js.LICENSE.txt */
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useI18n, useSite } from "@rspress/core/runtime";
import { IconDown, IconExternalLink, IconLink, SvgWrapper, copyToClipboard } from "@rspress/core/theme";
import { useEffect, useMemo, useRef, useState } from "react";
import "./index.css";
import "./LlmsViewOptions.css";
...
function LlmsViewOptions({ options: propsOptions }) {
    const { site } = useSite();
    const llmsUI = site?.themeConfig?.llmsUI;
    const options = ('object' == typeof llmsUI ? llmsUI?.viewOptions : propsOptions) ?? DEFAULT_OPTIONS;
    ...
    const items = useMemo(()=>{
        ...
        return {
            markdownLink: {
                ...
                icon: /*#__PURE__*/ jsx(SvgWrapper, {
                    icon: IconLink
                }),
                onClick: ()=>{
                    copyToClipboard(fullMarkdownUrl);
                }
            },
            chatgpt: {
                title: t('openInText', {
